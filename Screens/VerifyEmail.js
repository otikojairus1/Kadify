...
<View style={{height:100, paddingLeft:17, marginTop:100, backgroundColor:light}}>
  <Text style={{ fontSize:34, fontWeight:'bold'}}>Verify</Text>
  <Text style={{ fontSize:34, fontWeight:'bold'}}> Your Account!</Text>
</View>
...
<View style={{height: 100, paddingLeft:17, marginBottom:20, backgroundColor:light}}>
 <Text style={{ fontSize:16, }}> Enter the 4digit code we have sent in your email</Text>
